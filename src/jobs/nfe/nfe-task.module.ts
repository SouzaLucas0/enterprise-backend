...
import { TaskNfeService } from './nfe-task.service';


@Module({
	imports: [FirebirdModule, WhatsappModule, MessagesModule, CustomerModule, forwardRef(() => PdfModule), ParamsModule, LogsModule, NotificationsModule, AppMetaModule],
	providers: [TaskNfeService],
	exports: [TaskNfeService],
})
export class TaskNfeModule {}
